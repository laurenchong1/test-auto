...
class Bicycle:
    ...
    def __init__(self, front_chainrings, rear_cogs):
        ...
        # ERROR 1 - should be  = sorted(front_chainrings)
    ...
    def get_gear_inches(self):
        ...
        # ERROR 2 - should be multiplied by 27 (wheel diameter)
        return self.front_chainring_values[self.current_chainring-1]/self.rear_cogs_values[self.current_rear_cog-1] * 27
    ...
    def set_rear_cog(self, rear_cog_num):
        ...
        if rear_cog_num < 1 or rear_cog_num > self.num_rear_cogs:
            # ERROR 3 - should raise a ValueError
            raise ValueError
    ...
    def set_front_chainring(self, chainring_num):
        ...
        # otherwise set current cog number
        # ERROR 4 - should be setting self.current_chainring
    ...
    def is_single_speed(self):
        ...
        # ERROR 5 - should return False or not return anything (which is equivalent)
        return False
